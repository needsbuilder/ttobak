...
<p align="center">
  <img src="assets/brand/demo.gif" width="880" alt="또박 웹 데모 실행 화면 — 청년월세 안내문을 붙여넣고 변환하면 원문과 쉬운 글이 나란히 뜨고, K-ER 점수와 사실충실성 판정이 함께 표시된다">
</p>

<p align="center">
  <sub>
  실제 실행 화면입니다(합성·편집 없음, 로컬 <code>qwen2.5:7b</code>).<br>
  원문의 <b>“만 19세 이상”</b>이 쉬운 글에서 <b>“19세에서”</b>로 바뀌자, 또박은 자격 경계가
  흐려진 것으로 보고 <b>검수 필요</b>로 회부했습니다 — 그럴듯하게 고쳐놓고 넘어가지 않습니다.
  </sub>
</p>
