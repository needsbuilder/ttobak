...
- **사회적 임팩트 + 한국 적합성**: 「발달장애인 권리보장법」 제10조가 부과한 법적 의무를 직접 겨냥(단, 제10조가 위임한 '쉬운 정보'의 구체적 기준은 11년째 하위법령 미제정 — 경향신문 2026-06-02·에이블뉴스 2025-10-22). **공공정보 중 쉬운 정보로 제공되는 비율은 1%대로 추정**(이큐포올·소소한소통·국민연금공단 NIA 컨소시엄 보도자료, 2025-07-21; 정부통계 아닌 업계 추정치), 성인 낮은 문해력은 교육부·국가평생교육진흥원 성인문해능력조사 기준 16.6%(2023 제4차)·20.2%(2020 제3차, 약 890만 명, 수준1~3) — 이 격차를 메움.
