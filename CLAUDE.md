...
린터: ruff(F/E9만 — 결함 탐지용, 스타일 강제 아님, `ruff check ttobak/ tooling/ scripts/ tests/`). 포매터 없음. CI(`.github/workflows/ci.yml`)는 ruff + pytest + 라이선스 허용목록 + assets 분리 검사 + 감사 게이트 5중이다.
